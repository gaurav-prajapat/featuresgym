...
// Get terms and conditions content from system settings
$termsContent = '';
try {
    $stmt = $conn->prepare("SELECT setting_value FROM system_settings WHERE setting_key = 'terms_conditions'");
    $stmt->execute();
    $result = $stmt->fetch(PDO::FETCH_ASSOC);
    if ($result) {
        $termsContent = $result['setting_value'];
    }
...
<div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-12">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-3xl overflow-hidden mb-8">
            <div class="p-6 bg-gradient-to-r from-yellow-400 to-yellow-500 dark:from-yellow-500 dark:to-yellow-600">
                <h1 class="text-4xl font-bold text-gray-900 dark:text-gray-900 text-center">Terms of Service</h1>
                <p class="text-lg text-gray-800 dark:text-gray-800 text-center mt-2">Last Updated: <?php echo date('F d, Y'); ?></p>
            </div>
        </div>

        <div class="bg-white dark:bg-gray-800 shadow-md rounded-3xl overflow-hidden p-6 mb-8">
            <div class="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
                <?php if (!empty($termsContent)): ?>
                    <?php echo $termsContent; ?>
                <?php else: ?>
                    <!-- Default Terms of Service content -->
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mb-4">1. Acceptance of Terms</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">2. User Accounts</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">3. Membership and Payments</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">4. Scheduling and Attendance</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">5. Tournament Participation</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">6. User Conduct</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">7. Intellectual Property</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">8. Limitation of Liability</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">9. Indemnification</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">10. Termination</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">11. Governing Law</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">12. Changes to Terms</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">13. Dispute Resolution</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">14. Entire Agreement</h2>
                    ...
                    <h2 class="text-2xl font-semibold text-yellow-500 dark:text-yellow-400 mt-6 mb-4">15. Contact Information</h2>
                    <p>If you have any questions about these Terms, please contact us at:</p>
                    <p>Email: legal@featuresgym.com<br>
                    Phone: +91-1234567890<br>
                    Address: 123 Fitness Street, Workout City, WO 12345</p>
                <?php endif; ?>
                
                <div class="mt-8 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg">
                    <p class="font-semibold text-gray-800 dark:text-gray-200">By using our platform, you acknowledge that you have read these Terms of Service, understand them, and agree to be bound by them.</p>
                </div>
            </div>
        </div>
    </div>
