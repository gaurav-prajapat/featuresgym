...
<div class="container mx-auto px-4 py-20">
            ...
            <form action="process_withdrawal.php" method="POST" class="space-y-6" id="withdrawalForm">
                <div>
                    ...
                    <div class="flex justify-between mt-1 text-sm">
                        ...
                        <p class="text-gray-500">Maximum: ₹<?php echo number_format($balance['total_revenue'], 2); ?></p>
                    </div>
                </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                Withdrawals are typically processed within 1-3 business days. You'll receive a notification once your withdrawal is processed.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="px-6 py-3 bg-gray-50 flex flex-wrap items-center justify-between">
                ...
                <div class="text-sm text-gray-600">
                    Showing <?= min(($page - 1) * $limit + 1, $totalWithdrawals) ?> to <?= min($page * $limit, $totalWithdrawals) ?> of <?= $totalWithdrawals ?> withdrawals
                </div>
            </div>
                            ...
                            <?php foreach ($withdrawals as $withdrawal): ?>
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900"><?php echo date('M j, Y', strtotime($withdrawal['created_at'])); ?></div>
                                        <div class="text-xs text-gray-500"><?php echo date('g:i A', strtotime($withdrawal['created_at'])); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900">₹<?php echo number_format($withdrawal['amount'], 2); ?></div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mt-8">
        ...
        <div class="space-y-4">
                            ...
                            <?php if ($method['method_type'] === 'bank'): ?>
                                ...
                                <p class="text-sm text-gray-600">
                                    **** <?= substr($method['account_number'], -4) ?>
                                    <?php echo $method['is_primary'] ? ' <span class="text-green-600 font-semibold">(Primary)</span>' : ''; ?>
                                </p>
                            <?php else: ?>
            ...
            <div class="mt-6">
                <button onclick="toggleAddPaymentForm()" class="bg-gray-100 hover:bg-gray-200 text-gray-800 px-4 py-2 rounded-lg transition-colors duration-200 w-full flex items-center justify-center">
