...
$base_url = 'http://localhost/featuresgym';
...
<head>
    ...
    <title><?= htmlspecialchars($site_settings['seo']['site_title'] ?? 'Featuresgym - Find Your Perfect Gym') ?></title>
...
<body class="theme-transition">
    ...
    <script>
        ...
        <script>
            ...
            // JavaScript for toggling mobile menu with improved functionality
            document.addEventListener('DOMContentLoaded', function () {
                ...
                dropdownButtons.forEach(button => {
                    ...
                    button.parentElement.addEventListener('mouseenter', function () {
                        ...
                        document.querySelectorAll('.group > div').forEach(menu => {
                            if (menu !== dropdown) {
                    ...
                    // Desktop: Hide dropdown when mouse leaves the group
                    ...
                    // Mobile & Desktop: Toggle dropdown on click
                    button.addEventListener('click', function (e) {
                        ...
                        // Then show this dropdown if it was hidden
                        if (isHidden) {
                            dropdown.classList.remove('hidden');
                        }
                    });
